...
* [**Akses Databases MySQL dengan Python**](https://github.com/dsciencelabs/JNE_Data_Analytics_PySQL/blob/main/jupyterlab/01_py_sql.ipynb)

* [**Akses Databases PostgreSQL dengan Python**](https://github.com/dsciencelabs/JNE_Data_Analytics_PySQL/blob/main/jupyterlab/01_py_postgresql.ipynb)
 
## Latihan 

Materi latihan akan diberikan setalah toturial selesai.
