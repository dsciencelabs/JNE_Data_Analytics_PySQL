...
Pada materi sebelumnya telah dipelajari bagaimana untuk melakukan `CRUD` database. `CRUDS` merupakan singkatan dari **Create, Read, Update, dan Delete Berikut ini akan diperlihatkan cara untuk menambahkan daftar database dari CSV. Langkah pertama, import data dari Excel menggukan Python.
...
```{python, eval=FALSE}
sql = 'SELECT * FROM distribution_centers LIMIT 5;'
or_by = pd.read_sql(sql, db2)
or_by
```
