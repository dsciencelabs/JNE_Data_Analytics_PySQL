...
```{python, eval=F}
barang = pd.read_sql_table('barang', en_co)
barang
```
...
```{python, eval=F}
pelanggan = pd.read_sql_table('pelanggan', en_co)
pelanggan
```
...
```{python, eval=F}
penjualan = pd.read_sql_table('penjualan', en_co)
penjualan
```
...
```{python, eval=F}
detail_penjualan = pd.read_sql_table('penjualan_detail', en_co)
detail_penjualan
```
